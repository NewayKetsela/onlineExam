...
<div class="content-wrapper">
         ...
         <form method='post'>
            ...
            <table width="100%" border="1" bordercolor="#bdaaaa"  >
                    <tr>
                      <th bgcolor="#e9eee2" class="style3"><div style=" text-align: left !important;" class="style9 style5"><strong>STUDENT ID</strong></div></th>
                      ...
                      <th bgcolor="#e9eee2" class="style3"><div align="left" class="style9 style5"><strong>MIDDLE NAME</strong></div></th>
                       ...
                       <th bgcolor="#e9eee2" class="style3"><div align="left" class="style9 style5"><strong>DEPARTMENT NAME</strong></div></th>
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td bgcolor="#f8feff" class="style3">
                                        <div align="left" class="style9 style6"><a href="update_student.php?STUDENT_ID=<?php echo $e_id;?> " >
                                        Edit</a></div></td>
                                </tr>
                    <?php
                            }
