      ...
      <br><br><br>
         ...
         <div class="container">
            <form  action="#" method="POST">
               ...
               <input type="file" class="form-control" id="ffile" name="f" placeholder="Enter the answer"><br>
                              <h1>Upload Question File</h1>
                              <form>
                                 <input type="file" id="fileInput">
                                 <button type="button" onclick="validateFile()">Validate</button>
                              </form>
                              <div id="validationResult"></div><br><br>
