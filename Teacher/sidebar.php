                  ...
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                           ...
                           <li class="nav-item">
                              <a href="manage_exam.php" class="nav-link">
                                 <i class="nav-icon fa fa-book"></i>
                                 <p>Edit Exam</p>
                              </a>
                           </li>
                     ...
                     <li class="nav-item">
                        <a href="request_evaluation.php" class="nav-link">
                           <i class="nav-icon fa fa-poll"></i>
                           <p>
                           Request Evaluation
                           </p>
                     ...
                     <li class="nav-item">
                        <a href="evaluate_answer_student.php" class="nav-link">
                           <i class="nav-icon fa fa-poll"></i>
                           <p>
                           Evaluate Answer
                           </p>
                     ...
                     <li class="nav-item">
                        <a href="update_acc_teacher.php" class="nav-link">
                           <i class="nav-icon fa fa-poll"></i>
                           <p>
                           Update Account
                           </p>
